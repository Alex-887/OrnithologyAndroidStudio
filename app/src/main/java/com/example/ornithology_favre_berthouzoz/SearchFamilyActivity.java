...
public class SearchFamilyActivity extends AppCompatActivity {
    ...
    private FamilyListViewModelFirebase viewModel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new RecyclerAdapter_Family<>(new RecyclerViewItemClickListener() {
            ...
            public void onItemClick(View v, int position) {
                ...
                Log.d(TAG, "clicked on: " + families.get(position).getFamily());
...
//                startActivity(intent);
            ...
            public void onItemLongClick(View v, int position) {
                ...
                Log.d(TAG, "longClicked on: " + families.get(position).getFamily());
        ...
        viewModel = new ViewModelProvider(this, factory).get(FamilyListViewModelFirebase.class);
        viewModel.getFamilies().observe(this, family_firebases -> {
            if (family_firebases != null) {
                families = family_firebases;
                adapter.setData(families);
            }
        });
